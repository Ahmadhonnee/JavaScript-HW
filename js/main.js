...
if(user.lang == "EN"){
    ...
    user.want = alert("Would you like to see how many seconds you've spend in this life?");
    // if (user.want = "Yes"){
    ...
    user.want = alert("Bu hayotda necha soniya vaqt sarflaganingizni ko'rishni xohlaysizmi?")
    // if (user.want = "Ha"){
        user.second = user.age * 31536000;
    ...
    user.want = alert("Хотите узнать, сколько секунд вы провели в этой жизни?")
    // if (user.want = "Да"){
        user.second = user.age * 31536000;
